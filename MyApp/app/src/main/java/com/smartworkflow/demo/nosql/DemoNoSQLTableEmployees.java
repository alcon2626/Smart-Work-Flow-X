...
public class DemoNoSQLTableEmployees extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableEmployees.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKeyAndSortKey extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() {
            ...
            result = mapper.load(EmployeesDO.class, AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID(), "demo-FirstName-500000");
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLEmployeesResult(result));
    ...
    public class DemoQueryWithPartitionKeyAndSortKeyCondition extends DemoNoSQLOperationBase {
        ...
        private PaginatedQueryList<EmployeesDO> results;
        private Iterator<EmployeesDO> resultsIterator;
        ...
        @Override
        public boolean executeOperation() {
            final EmployeesDO itemToFind = new EmployeesDO();
            ...
            final DynamoDBQueryExpression<EmployeesDO> queryExpression = new DynamoDBQueryExpression<EmployeesDO>()
                .withHashKeyValues(itemToFind)
                .withRangeKeyCondition("FirstName", rangeKeyCondition)
                .withConsistentRead(false)
                .withLimit(RESULTS_PER_RESULT_GROUP);

            results = mapper.query(EmployeesDO.class, queryExpression);
            if (results != null) {
    ...
    public class DemoQueryWithPartitionKeyAndFilter extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() {
            ...
            filterExpressionAttributeNames.put("#City", "City");

            final Map<String, AttributeValue> filterExpressionAttributeValues = new HashMap<>();
            filterExpressionAttributeValues.put(":MinCity",
                new AttributeValue().withS("demo-City-500000"));

            final DynamoDBQueryExpression<EmployeesDO> queryExpression = new DynamoDBQueryExpression<EmployeesDO>()
                .withHashKeyValues(itemToFind)
                .withFilterExpression("#City > :MinCity")
    ...
    public class DemoScanWithFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<EmployeesDO> results;
        private Iterator<EmployeesDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            results = mapper.scan(EmployeesDO.class, scanExpression);
            if (results != null) {
                resultsIterator = results.iterator();
                if (resultsIterator.hasNext()) {
                    return true;
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<EmployeesDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final EmployeesDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLEmployeesResult(item));
            itemsRetrieved++;
    ...
    public DemoNoSQLTableEmployees() {
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final EmployeesDO firstItem = new EmployeesDO();

        firstItem.setUserId(AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());
        firstItem.setFirstName("demo-FirstName-500000");
        firstItem.setCity(
            DemoSampleDataGenerator.getRandomSampleString("City"));
        firstItem.setClockStatus(DemoSampleDataGenerator.getRandomSampleBool());
        firstItem.setCompany(
            DemoSampleDataGenerator.getRandomSampleString("Company"));
        firstItem.setFamilyName(
            DemoSampleDataGenerator.getRandomSampleString("FamilyName"));
        ...
        final EmployeesDO[] items = new EmployeesDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final EmployeesDO item = new EmployeesDO();
            ...
            item.setClockStatus(DemoSampleDataGenerator.getRandomSampleBool());
            item.setCompany(DemoSampleDataGenerator.getRandomSampleString("Company"));
            item.setFamilyName(DemoSampleDataGenerator.getRandomSampleString("FamilyName"));
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        final PaginatedQueryList<EmployeesDO> results = mapper.query(EmployeesDO.class, queryExpression);

        Iterator<EmployeesDO> resultsIterator = results.iterator();
        ...
        final List<EmployeesDO> batchOfItems = new LinkedList<EmployeesDO>();
